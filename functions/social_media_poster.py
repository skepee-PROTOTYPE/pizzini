...
# Lazy import flags - actual imports happen when needed to save memory
AZURE_TTS_AVAILABLE = True  # Will check when actually used
COQUI_TTS_AVAILABLE = False  # Disabled to save memory
PYDUB_AVAILABLE = False  # Optional feature
